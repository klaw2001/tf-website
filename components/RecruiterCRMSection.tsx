...
export default function RecruiterCRMSection() {
  return (
    <section data-aos="fade-up" className="py-16 sm:py-24 bg-gray-50 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="relative order-2 lg:order-1">
            <div className="relative bg-white rounded-2xl sm:rounded-3xl shadow-2xl border border-gray-200 overflow-hidden max-w-lg mx-auto lg:max-w-none">
              ...
              <div className="p-4 sm:p-6">
                ...
                <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                  <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl sm:rounded-2xl p-3 sm:p-4 border-2 border-blue-200">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                      <div className="flex items-center space-x-2">
                        <div className="flex -space-x-1">
                          ...
                          <div className="w-5 h-5 sm:w-6 sm:h-6 bg-gradient-to-r from-indigo-400 to-indigo-600 rounded-full border-2 border-white"></div>
                          <div className="w-5 h-5 sm:w-6 sm:h-6 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full border-2 border-white"></div>
                        </div>
                        <span className="text-xs text-gray-600">+12 more candidates</span>
                      </div>
                      <button className="px-3 py-1 bg-blue-600 text-white rounded-lg text-xs font-medium hover:bg-blue-700 transition-colors cursor-pointer whitespace-nowrap">
                        View All
                      </button>
                    </div>
                  </div>
            ...
            <div className="absolute -top-4 -left-4 sm:-top-6 sm:-left-6 w-16 h-16 sm:w-24 sm:h-24 bg-gradient-to-r from-blue-300/30 to-indigo-300/30 rounded-full blur-xl"></div>
          ...
          <div className="order-1 lg:order-2 lg:pl-8">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
              Manage your
              <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent"> entire pipeline </span>
              in one place
            </h2>
